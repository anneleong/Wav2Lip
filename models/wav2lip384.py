...
from .conv384 import Conv2dTranspose, Conv2d, nonorm_Conv2d

class Wav2Lip384(nn.Module):
    def __init__(self, audio_encoder=None):
        super(Wav2Lip384, self).__init__()

        self.face_encoder_blocks = nn.ModuleList([
            # face_encoder_blocks.0.0
            nn.Sequential(Conv2d(6, 16, kernel_size=7, stride=1, padding=3, act="leaky"),
            # face_encoder_blocks.0.1
            Conv2d(16, 16, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.0.2
            Conv2d(16, 16, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.0.3
            Conv2d(16, 16, kernel_size=3, stride=1, padding=1, residual=True, act="leaky")), # 384, 384
            
            # face_encoder_blocks.1.0
            nn.Sequential(Conv2d(16, 32, kernel_size=3, stride=2, padding=1, act="leaky"), # 192, 192
            # face_encoder_blocks.1.1
            Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.1.2
            Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.1.3
            Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True, act="leaky")),

            # face_encoder_blocks.2.0
            nn.Sequential(Conv2d(32, 64, kernel_size=3, stride=2, padding=1, act="leaky"), # 96, 96
            # face_encoder_blocks.2.1
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.2.2
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.2.3
            Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True, act="leaky")),

            # face_encoder_blocks.3.0
            nn.Sequential(Conv2d(64, 128, kernel_size=3, stride=2, padding=1, act="leaky"),    # 48, 48
            # face_encoder_blocks.3.1
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.3.2
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.3.3
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True, act="leaky")),

            # face_encoder_blocks.4.0
            nn.Sequential(Conv2d(128, 256, kernel_size=3, stride=2, padding=1, act="leaky"),   # 24, 24
            # face_encoder_blocks.4.1
            Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.4.2
            Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.4.3
            Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True, act="leaky")),

            # face_encoder_blocks.5.0
            nn.Sequential(Conv2d(256, 512, kernel_size=3, stride=2, padding=1, act="leaky"),       # 12, 12
            # face_encoder_blocks.5.1
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.5.2
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.5.3
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True, act="leaky")),

            # face_encoder_blocks.6.0
            nn.Sequential(Conv2d(512, 1024, kernel_size=3, stride=2, padding=1, act="leaky"),     # 6, 6
            # face_encoder_blocks.6.1
            Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.6.2
            Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.6.3
            Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1, residual=True, act="leaky")),
            ...
            # Modified blocks
            ##################
            # face_encoder_blocks.7.0
            nn.Sequential(Conv2d(1024, 1024, kernel_size=3, stride=2, padding=1, act="leaky"),       # 3, 3
            # face_encoder_blocks.7.1
            Conv2d(1024, 1024, kernel_size=1, stride=1, padding=1, residual=True, act="leaky"),
            # face_encoder_blocks.7.2
            Conv2d(1024, 1024, kernel_size=1, stride=1, padding=1, residual=True, act="leaky")),
...
class Wav2Lip_disc_qual384(nn.Module):
    def __init__(self):
        super(Wav2Lip_disc_qual384, self).__init__()
